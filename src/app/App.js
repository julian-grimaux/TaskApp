                                ...
                                <form onSubmit={this.addTask}>
                                    <div className='row'>
                                        <div className='input-field col s12'>
                                            <input name='title' value={this.state.title} onChange={this.handleChange} type='text' placeholder="Task Title"></input>
                                        </div>
                                    </div>
                                    <div className='row'>
                                        <div className='input-field col s12'>
                                        ...
                                        return (
                                            <tr key={task._id}>
                                                ...
                                                <td>
                                                    ...
                                                    <button className='btn red darken-3' style={{margin: '4px'}} onClick={() => this.deleteTask(task._id)}>
